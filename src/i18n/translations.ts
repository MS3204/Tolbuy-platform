// Centralized translation store for TolBuy.
// Add new languages by appending to `languages` and providing a matching dictionary.

export type LanguageCode = "en" | "ar" | "es" | "fr" | "de" | "zh";

export interface LanguageMeta {
  code: LanguageCode;
  /** Name shown in its own native script */
  nativeName: string;
  /** English name for accessibility / fallback */
  englishName: string;
  /** Layout direction */
  dir: "ltr" | "rtl";
  /** Emoji flag-ish marker */
  flag: string;
}
...
const en: Dict = {
  ...
  "feed.heroSubtitle":
    "Shop, trade and invest in one adaptive interface. Tolsentinel AI watches every signal and surfaces what matters — only when it matters.",
  ...
  "feed.item1.body":
    "Your last 6 trades cluster around tech ETFs. A diversification opportunity in clean energy is rising +14% this week.",
  ...
  "feed.item4.body":
    "12 verified suppliers in Istanbul match your saved query 'organic cotton'.",
  ...
  "shop.title": "Shop",
  "shop.subtitle":
    "Every product comes pre-analyzed. Tap to expand AI insight.",
  "shop.searchPlaceholder":
    "Ask Tolsentinel: 'best leather backpack under $150'",
  ...
  "trade.subtitle":
    "No complex charts. AI interprets every market signal for you.",
  ...
  "wallet.tokensDesc":
    "Use tokens for fee discounts, premium features and exclusive deals.",
  ...
  "wallet.tolToken.subtitle":
    "Earn points from platform actions and redeem perks instantly (localStorage demo).",
  "wallet.tolToken.balance": "TolToken Balance",
  "wallet.tolToken.balanceDesc":
    "Non-transferable internal utility points. Stored locally for the demo.",
  ...
  "wallet.demo.storage":
    "Demo uses localStorage. Replace walletStore later to use real API.",
  ...
  "wallet.history.empty":
    "No TolToken activity yet. Earn tokens to generate history.",

  "wallet.fraud.title": "Suspicious activity pending review",
  "wallet.fraud.body":
    "TolSentinel placeholder flagged an earning spike. Balance was not credited in this demo.",
  ...
  "perk.contentPremium.desc":
    "Unlock exclusive digital content for a limited set.",
  ...
  "sell.subtitle":
    "Drag a photo. Tolsentinel writes the listing, sets the price and matches buyers in seconds.",
  ...
  "sell.previewBody":
    "1958, fully serviced, original leather case. Ideal for film enthusiasts. Auto-translated to 12 languages.",
  ...
  "about.intro":
    "TolBuy unifies commerce, trading, and investing into one adaptive ecosystem — guided by Tolsentinel AI, our proprietary economic intelligence engine.",
  "about.tolbuyBody":
    "The primary brand and platform — a unified marketplace where products, markets, and capital flow through one intelligent interface.",
  "about.tolsentinelBody":
    "The AI sub-brand that powers personalization, market signals, and decision support across every TolBuy surface. A sentinel for your economic life.",
  "about.tmParent": "Parent company",
  "about.tmBody1": "TolBuy is",
  "about.tmBody2": "a TM Group company",
  "about.tmBody3":
    ". TM Group is the parent organization behind TolBuy and Tolsentinel AI, investing in the next generation of intelligent economic infrastructure.",
  // Footer
  ...
  "orb.commandCenterBody":
    "Tolsentinel AI command center is under development. The intelligent agent will be integrated soon to provide real-time market insights, trading recommendations, and personalized economic guidance.",
  ...
  "ai.howWorks.body":
    "Tolsentinel AI watches every signal across shopping, trading, and investing. It surfaces what matters — only when it matters. Every interaction makes it smarter about your preferences and goals.",
...
const ar: Dict = {
  ...
  "feed.heroSubtitle":
    "تسوّق وتداول واستثمر في واجهة واحدة متكيّفة. يراقب Tolsentinel AI كل إشارة ويُظهر ما يهم — فقط عندما يهم.",
  ...
  "feed.item1.body":
    "تتركز صفقاتك الست الأخيرة حول صناديق التكنولوجيا. هناك فرصة تنويع في الطاقة النظيفة ترتفع +14٪ هذا الأسبوع.",
  ...
  "feed.item4.body":
    "12 مورّداً موثوقاً في إسطنبول يطابقون استعلامك المحفوظ 'قطن عضوي'.",
  "feed.item4.cta": "عرض التطابقات",
  "feed.item5.title": "مراقبة الإنفاق",
  "feed.item5.body":
    "الاشتراكات +18٪ شهرياً. ألغِ اثنين غير مستخدمين لتوفير 34$ شهرياً.",
  ...
  "trade.subtitle":
    "لا رسوم بيانية معقدة. يفسر الذكاء الاصطناعي كل إشارة سوق لك.",
  ...
  "wallet.tokensDesc":
    "استخدم التوكنات لخصومات الرسوم والميزات المميزة والعروض الحصرية.",
  ...
  "sell.subtitle":
    "اسحب صورة. يكتب Tolsentinel القائمة، ويحدد السعر، ويطابق المشترين في ثوانٍ.",
  "sell.dropPhoto": "أفلت صورة أو فيديو",
  "sell.autoGen":
    "ينشئ الذكاء الاصطناعي العنوان والوصف والسعر والوسوم تلقائياً",
  ...
  "sell.previewBody":
    "1958، مُصانة بالكامل، حقيبة جلدية أصلية. مثالية لعشاق التصوير الفيلمي. مترجمة تلقائياً إلى 12 لغة.",
  ...
  "sell.logisticsBody":
    "3 شركات شحن جاهزة · استلام خلال ساعتين · 184 مشترياً قريباً",
  "about.kicker": "حول",
  "about.title1": "الكون الاقتصادي",
  "about.title2": "الذكي",
  "about.intro":
    "يوحّد TolBuy التجارة والتداول والاستثمار في نظام بيئي واحد متكيّف — بقيادة Tolsentinel AI، محرك الذكاء الاقتصادي الخاص بنا.",
  "about.tolbuyBody":
    "العلامة والمنصة الأساسية — سوق موحّد تتدفق فيه المنتجات والأسواق ورأس المال عبر واجهة ذكية واحدة.",
  "about.tolsentinelBody":
    "العلامة الفرعية للذكاء الاصطناعي التي تشغّل التخصيص وإشارات السوق ودعم القرار عبر كل واجهات TolBuy. حارس لحياتك الاقتصادية.",
  "about.tmParent": "الشركة الأم",
  "about.tmBody1": "TolBuy هي",
  "about.tmBody2": "شركة تابعة لـ TM Group",
  "about.tmBody3":
    ". TM Group هي المؤسسة الأم وراء TolBuy و Tolsentinel AI، تستثمر في الجيل القادم من البنية التحتية الاقتصادية الذكية.",
  "footer.rights": "جميع الحقوق محفوظة.",
  "footer.tmCompany": "شركة تابعة لـ TM Group",
  "orb.commandCenter": "مركز القيادة",
  "orb.commandCenterTitle": "مركز القيادة",
  "orb.commandCenterBody":
    "مركز قيادة Tolsentinel AI قيد التطوير. سيتم دمج الوكيل الذكي قريباً لتقديم رؤى سوق فورية وتوصيات تداول وإرشاد اقتصادي مخصص.",
...
const es: Dict = {
  ...
  "feed.heroSubtitle":
    "Compra, opera e invierte en una interfaz adaptativa. Tolsentinel AI vigila cada señal y muestra lo importante — solo cuando importa.",
  ...
  "feed.item1.body":
    "Tus últimas 6 operaciones se concentran en ETFs tecnológicos. Una oportunidad de diversificación en energía limpia sube +14% esta semana.",
  ...
  "feed.item4.body":
    "12 proveedores verificados en Estambul coinciden con tu búsqueda 'algodón orgánico'.",
  "feed.item4.cta": "Ver coincidencias",
  "feed.item5.title": "Vigilancia de gastos",
  "feed.item5.body":
    "Suscripciones +18% mensual. Cancela 2 sin usar para ahorrar $34/mes.",
  "feed.item5.cta": "Optimizar",
  "feed.item6.title": "Startup destacada: Verda",
  "feed.item6.body":
    "Tecnología climática, Serie A. Puntuación Sentinel 8.2/10.",
  ...
  "feed.premiumTag": "Tolsentinel AI Premium",
  "feed.premiumTitle":
    "Predice mercados. Optimiza ganancias. Protege la privacidad.",
  ...
  "feed.cancelAnytime":
    "Cancela cuando quieras · Paga con TolTokens y ahorra 10%",
  "shop.title": "Tienda",
  "shop.subtitle":
    "Cada producto viene preanalizado. Toca para ver el análisis de IA.",
  "shop.searchPlaceholder":
    "Pregunta a Tolsentinel: 'mejor mochila de cuero por menos de $150'",
  ...
  "trade.subtitle":
    "Sin gráficos complejos. La IA interpreta cada señal del mercado por ti.",
  ...
  "wallet.aiInsightBody":
    "Suscripciones ↑ 18% — cancela 2 sin usar para ahorrar",
  ...
  "wallet.tokensDesc":
    "Usa tokens para descuentos en tarifas, funciones premium y ofertas exclusivas.",
  ...
  "sell.subtitle":
    "Arrastra una foto. Tolsentinel escribe el anuncio, fija el precio y encuentra compradores en segundos.",
  ...
  "sell.previewBody":
    "1958, totalmente revisada, estuche de cuero original. Ideal para entusiastas del cine. Traducida automáticamente a 12 idiomas.",
  ...
  "sell.logisticsBody":
    "3 transportistas listos · recogida en 2h · 184 compradores cerca",
  "about.kicker": "Acerca de",
  "about.title1": "El universo económico",
  "about.title2": "inteligente",
  "about.intro":
    "TolBuy unifica comercio, trading e inversión en un ecosistema adaptativo — guiado por Tolsentinel AI, nuestro motor de inteligencia económica.",
  "about.tolbuyBody":
    "La marca y plataforma principal — un mercado unificado donde productos, mercados y capital fluyen a través de una interfaz inteligente.",
  "about.tolsentinelBody":
    "La submarca de IA que impulsa la personalización, señales de mercado y soporte de decisiones en cada superficie de TolBuy. Un centinela para tu vida económica.",
  "about.tmParent": "Empresa matriz",
  "about.tmBody1": "TolBuy es",
  "about.tmBody2": "una empresa de TM Group",
  "about.tmBody3":
    ". TM Group es la organización matriz detrás de TolBuy y Tolsentinel AI, invirtiendo en la próxima generación de infraestructura económica inteligente.",
  "footer.rights": "Todos los derechos reservados.",
  "footer.tmCompany": "Una empresa de TM Group",
  "orb.commandCenter": "Centro de mando",
  "orb.commandCenterTitle": "Centro de mando",
  "orb.commandCenterBody":
    "El centro de mando de Tolsentinel AI está en desarrollo. El agente inteligente se integrará pronto para ofrecer información de mercado en tiempo real, recomendaciones de trading y orientación económica personalizada.",
  "orb.commandCenterComing":
    "🚀 Llega con la integración completa del agente de IA",
  ...
  "orb.i1":
    "Las cámaras vintage suben +24% en tu región. Vale la pena anunciarlas.",
  ...
  "orb.i5":
    "El vendedor 'Atlas Goods' tiene +98% de confianza — coincidencia mayorista encontrada.",
...
const fr: Dict = {
  ...
  "feed.heroSubtitle":
    "Achetez, tradez et investissez dans une interface adaptative. Tolsentinel AI surveille chaque signal et révèle l'essentiel — uniquement quand cela compte.",
  ...
  "feed.item1.body":
    "Vos 6 derniers trades se concentrent sur des ETF tech. Une opportunité de diversification dans l'énergie propre monte de +14% cette semaine.",
  ...
  "feed.item4.body":
    "12 fournisseurs vérifiés à Istanbul correspondent à votre recherche 'coton bio'.",
  "feed.item4.cta": "Voir les correspondances",
  "feed.item5.title": "Surveillance des dépenses",
  "feed.item5.body":
    "Abonnements +18% par mois. Annulez 2 inutilisés pour économiser 34$/mois.",
  ...
  "feed.premiumTag": "Tolsentinel AI Premium",
  "feed.premiumTitle":
    "Prédisez les marchés. Optimisez les profits. Protégez la vie privée.",
  ...
  "feed.cancelAnytime":
    "Annulez à tout moment · Payez en TolTokens pour 10% de réduction",
  "shop.title": "Boutique",
  "shop.subtitle":
    "Chaque produit est pré-analysé. Touchez pour développer l'analyse IA.",
  "shop.searchPlaceholder":
    "Demandez à Tolsentinel : 'meilleur sac en cuir à moins de 150$'",
  ...
  "trade.subtitle":
    "Pas de graphiques complexes. L'IA interprète chaque signal du marché pour vous.",
  ...
  "wallet.aiInsightBody":
    "Abonnements ↑ 18% — annulez 2 inutilisés pour économiser",
  ...
  "wallet.tokensDesc":
    "Utilisez les jetons pour des réductions, des fonctionnalités premium et des offres exclusives.",
  ...
  "sell.subtitle":
    "Glissez une photo. Tolsentinel crée l'annonce, fixe le prix et trouve des acheteurs en quelques secondes.",
  ...
  "sell.previewBody":
    "1958, entièrement révisé, étui en cuir d'origine. Idéal pour les passionnés de cinéma. Traduit en 12 langues.",
  ...
  "sell.logisticsBody":
    "3 transporteurs prêts · ramassage en 2h · 184 acheteurs à proximité",
  "about.kicker": "À propos",
  "about.title1": "L'univers économique",
  "about.title2": "intelligent",
  "about.intro":
    "TolBuy unifie le commerce, le trading et l'investissement dans un écosystème adaptatif — guidé par Tolsentinel AI.",
  "about.tolbuyBody":
    "La marque principale — un marché unifié où les produits, les marchés et les capitaux circulent via une interface intelligente.",
  "about.tolsentinelBody":
    "La sous-marque d'IA qui gère la personnalisation, les signaux du marché et l'aide à la décision.",
  "about.tmParent": "Société mère",
  "about.tmBody1": "TolBuy est",
  "about.tmBody2": "une entreprise de TM Group",
  "about.tmBody3":
    ". TM Group est l'organisation mère derrière TolBuy et Tolsentinel AI.",
  ...
  "orb.i1":
    "Appareils photo vintage +24% dans votre région. Intéressant à lister.",
  ...
  "orb.i5":
    "Le vendeur 'Atlas Goods' a +98% de confiance — correspondance en gros trouvée.",
  "nf.title": "Perdu dans l'univers économique",
  "nf.body":
    "Cette dimension n'existe pas. Tolsentinel peut vous guider pour revenir.",
...
const de: Dict = {
  ...
  "feed.heroSubtitle":
    "Kaufen, handeln und investieren Sie in einer adaptiven Benutzeroberfläche. Tolsentinel AI überwacht jedes Signal.",
  ...
  "feed.item1.body":
    "Ihre letzten 6 Trades konzentrieren sich auf Technologie-ETFs.",
  ...
  "feed.item4.body":
    "12 verifizierte Lieferanten in Istanbul entsprechen Ihrer Anfrage 'Bio-Baumwolle'.",
  "feed.item4.cta": "Treffer anzeigen",
  "feed.item5.title": "Ausgabenwächter",
  "feed.item5.body":
    "Abonnements +18% MoM. Kündigen Sie 2 ungenutzte, um $34/Monat zu sparen.",
  ...
  "feed.premiumTag": "Tolsentinel AI Premium",
  "feed.premiumTitle":
    "Märkte vorhersagen. Gewinn optimieren. Privatsphäre schützen.",
  ...
  "feed.cancelAnytime":
    "Jederzeit kündigen · Mit TolTokens bezahlen für 10% Rabatt",
  "shop.title": "Shop",
  "shop.subtitle": "Jedes Produkt ist voranalysiert. Tippen für KI-Einblick.",
  "shop.searchPlaceholder":
    "Fragen Sie Tolsentinel: 'bester Lederrucksack unter $150'",
  ...
  "trade.subtitle":
    "Keine komplexen Charts. KI interpretiert jedes Marktsignal für Sie.",
  ...
  "wallet.aiInsightBody":
    "Abonnements ↑ 18% — Kündigen Sie 2 ungenutzte zum Sparen",
  "wallet.smartMove": "Kluger Schachzug",
  "wallet.smartMoveBody":
    "Verschieben Sie $1.200 zu hoher Rendite · prognostiziert",
  "wallet.privacy": "Privatsphäre",
  "wallet.privacyBody": "Geschützte Zahlungen aktiv",
  "wallet.tokensDesc":
    "Nutzen Sie Token für Gebührenrabatte, Premium-Funktionen und exklusive Angebote.",
  ...
  "sell.title2": "Überall.",
  "sell.subtitle":
    "Foto hineinziehen. Tolsentinel schreibt das Angebot, legt den Preis fest und findet Käufer.",
  ...
  "sell.previewBody":
    "1958, voll funktionsfähig, original Ledertasche. Automatisch in 12 Sprachen übersetzt.",
  ...
  "sell.logisticsBody":
    "3 Versanddienstleister bereit · Abholung in 2 Std. · 184 Käufer in der Nähe",
  "about.kicker": "Über uns",
  "about.title1": "Das intelligente",
  "about.title2": "Wirtschaftsuniversum",
  "about.intro":
    "TolBuy vereint Handel, Trading und Investment in einem adaptiven Ökosystem — gesteuert von Tolsentinel AI.",
  "about.tolbuyBody":
    "Die Hauptmarke — ein einheitlicher Marktplatz, auf dem Produkte, Märkte und Kapital fließen.",
  "about.tolsentinelBody":
    "Die KI-Submarke für Personalisierung, Marktsignale und Entscheidungsunterstützung.",
  "about.tmParent": "Muttergesellschaft",
  "about.tmBody1": "TolBuy ist",
  "about.tmBody2": "ein Unternehmen der TM Group",
  "about.tmBody3":
    ". Die TM Group ist die Mutterorganisation hinter TolBuy und Tolsentinel AI.",
  ...
  "orb.commandCenterBody":
    "Das Tolsentinel AI-Kommandozentrum befindet sich in Entwicklung. Der intelligente Agent wird bald integriert, um Echtzeit-Markteinblicke, Trading-Empfehlungen und personalisierte wirtschaftliche Orientierung bereitzustellen.",
  "orb.commandCenterComing":
    "🚀 Kommt mit der vollständigen Integration des KI-Agents",
  ...
  "orb.i1":
    "Vintage-Kameras legen in Ihrer Region um +24% zu. Listung lohnt sich.",
  ...
  "orb.i5":
    "Verkäufer 'Atlas Goods' hat +98% Vertrauen — Großhandels-Treffer gefunden.",
  "nf.title": "Verloren im Wirtschaftsuniversum",
  "nf.body":
    "Diese Dimension existiert nicht. Tolsentinel kann Sie zurückführen.",
...
const zh: Dict = {
  ...
  "feed.heroSubtitle":
    "在一个自适应界面中进行购物、交易和投资。Tolsentinel AI 监控每一个信号并呈现关键内容。",
  ...
  "feed.item1.body":
    "您最近的 6 笔交易集中在科技 ETF。本周清洁能源的多元化机会上涨了 +14%。",
  "feed.item1.cta": "探索配置",
  ...
  "feed.item4.body":
    "伊斯坦布尔的 12 家认证供应商与您保存的查询“有机棉”相匹配。",
  "feed.item4.cta": "查看匹配",
  "feed.item5.title": "开支监测",
  "feed.item5.body":
    "订阅费环比增长 +18%。取消 2 个未使用的订阅可每月节省 $34。",
  "feed.item5.cta": "优化",
  ...
  "sell.title2": "在任何地方。",
  "sell.subtitle":
    "拖入照片。Tolsentinel 自动编写商品详情、定价并在数秒内匹配买家。",
  ...
  "sell.previewBody":
    "1958年产，全机已保养，原装皮套。胶片爱好者理想之选。自动翻译至 12 种语言。",
  ...
  "about.title2": "经济宇宙",
  "about.intro":
    "TolBuy 将商业、交易和投资统一为一个自适应生态系统 — 由我们的专属经济智能引擎 Tolsentinel AI 引领。",
  "about.tolbuyBody":
    "主品牌与平台 — 一个统一的市场，产品、市场和资本通过一个智能界面流动。",
  "about.tolsentinelBody":
    "AI 子品牌，为跨 TolBuy 的每个界面提供个性化、市场信号和决策支持。您经济生活的哨兵。",
  "about.tmParent": "母公司",
  "about.tmBody1": "TolBuy 是",
  "about.tmBody2": "TM Group 旗下公司",
  "about.tmBody3":
    "。TM Group 是 TolBuy 和 Tolsentinel AI 的母组织，投资于下一代智能经济基础设施。",
